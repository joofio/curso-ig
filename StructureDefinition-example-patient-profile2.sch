...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://example.com/fhir/example/StructureDefinition/therapy-sessions-completed']) &lt;= 1">extension with URL = 'http://example.com/fhir/example/StructureDefinition/therapy-sessions-completed': maximum cardinality of 'extension' is 1</sch:assert>
